...
export const HookSceneV3: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bgCard, flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0 }}>
        ...
        {/* Strike-throughs — all 3 features */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 36 }}>
          <Sequence from={100} layout="none">
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 36 }}>
              <StrikeThrough before="100 pages" after="1,000 pages" strikeStartFrame={0} afterStartFrame={14} fontSize={52} />
              ...
              <Sequence from={80} layout="none">
                <StrikeThrough before="7 days of reports" after="60 days of reports" strikeStartFrame={0} afterStartFrame={14} fontSize={52} />
              </Sequence>
            </div>
          </Sequence>
        </div>
